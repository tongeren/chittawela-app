...
useStaticRendering(isServer); // useStaticRendering is not a hook: eslint false positive

let store: RootStoreModel | undefined;

// Note we have no data coming from the server that our stores need to be rehydrated with
export const initStore = (snapshot = null):RootStoreModel => {
...
export const useStore = (initialState: any):RootStoreModel => {
